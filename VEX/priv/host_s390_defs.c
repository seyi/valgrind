...
s390_insn_as_string(const s390_insn *insn)
{
   ...
   case S390_INSN_UNOP:
      ...
      case S390_VEC_COUNT_LEADING_ZEROEZ:
         op = "v-vclz";
         break;

      case S390_VEC_COUNT_TRAILING_ZEROEZ:
         op = "v-vctz";
         break;
   ...
   case S390_INSN_VEC_BINOP:
      ...
      case S390_VEC_ELEMENT_SHIFT_LEFT: op = "v-velemshl"; break;
      case S390_VEC_ELEMENT_SHIFT_RIGHT_ARITHMETIC: op = "v-velemsar"; break;
...
s390_insn_unop_emit(UChar *buf, const s390_insn *insn)
{
   ...
   case S390_VEC_DUPLICATE: {
      ...
      UChar v1 = hregNumber(insn->variant.unop.dst);
      UChar v3 = hregNumber(insn->variant.unop.src.variant.reg);
      return s390_emit_VREP(buf, v1, v3, s390_getM_from_size(insn->size));
      }
   case S390_VEC_ABS: {
      vassert(insn->variant.unop.src.tag == S390_OPND_REG);
      UChar v1 = hregNumber(insn->variant.unop.dst);
...
s390_insn_vec_binop_emit(UChar *buf, const s390_insn *insn)
{
   ...
   switch (tag) {
      ...
      case S390_VEC_ELEMENT_SHIFT_LEFT:
         return s390_emit_VESLV(buf, v1, v2, v3, s390_getM_from_size(size));
      case S390_VEC_ELEMENT_SHIFT_RIGHT_ARITHMETIC:
