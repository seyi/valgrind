...
/*------------------------------------------------------------*/
   ...
   /*
   The reason to use unions is that fpr{0..15} and bits 0..63 of
   vr{0..15} is the same memory in s390 processor. For example changing fpr1 affects
   vr1 too. According to documentation if we modify fpr1 then the content of vr1's 64..128
   ...
   */
   ...
   /*   80 */  union{ ULong guest_f1;  V128  guest_v1; };
   /*   96 */  union{ ULong guest_f2;  V128  guest_v2; };
   /*  112 */  union{ ULong guest_f3;  V128  guest_v3; };
   /*  128 */  union{ ULong guest_f4;  V128  guest_v4; };
   /*  144 */  union{ ULong guest_f5;  V128  guest_v5; };
   /*  160 */  union{ ULong guest_f6;  V128  guest_v6; };
   /*  176 */  union{ ULong guest_f7;  V128  guest_v7; };
   /*  192 */  union{ ULong guest_f8;  V128  guest_v8; };
   /*  208 */  union{ ULong guest_f9;  V128  guest_v9; };
   /*  224 */  union{ ULong guest_f10; V128  guest_v10; };
   /*  240 */  union{ ULong guest_f11; V128  guest_v11; };
   /*  256 */  union{ ULong guest_f12; V128  guest_v12; };
   /*  272 */  union{ ULong guest_f13; V128  guest_v13; };
   /*  288 */  union{ ULong guest_f14; V128  guest_v14; };
